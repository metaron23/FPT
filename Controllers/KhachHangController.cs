    ...
    public class KhachHangController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.KhachHangs != null ? 
                          ...
                          Problem("Entity set 'QlksContext.KhachHangs'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MaKh,TenKh")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MaKh,TenKh")] KhachHang khachHang)
        {
            if (id != khachHang.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'QlksContext.KhachHangs'  is null.");
            }
            var khachHang = await _context.KhachHangs.FindAsync(id);
            if (khachHang != null)
            {
